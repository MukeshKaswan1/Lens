...
const list1 = ['State-of-the-art solutions','Fast & Efficient','No extra computation fee','No licensing fee'];
...
function Why() {
  return (
    <div className='bg-whychoose min-h-screen text-white flex flex-col items-center text-center px-6 md:px-12 lg:px-24 xl:px-32'>
      <div className='mt-16 text-4xl md:text-5xl lg:text-6xl font-semibold'>WHY CHOOSE LENS</div>
      <div className='rounded-lg mt-2 bg-gradient-to-r from-[#0091ff] to-[#9cfeff] w-16 h-1 text-black mb-8 md:mb-12'></div>
      <div className='text-lg md:text-xl lg:text-2xl mb-12 md:w-3/4 lg:w-2/3 xl:w-1/2'>
        AI-driven solutions backed by science. Every piece of AI technology shipped from LENS is thoroughly benchmarked via rigorous evaluations. With a global network of experts and academicians, we guarantee the most accurate and robust solutions in the market.
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:w-3/4 lg:w-2/3 xl:w-4/5'>
        {cardItems.map((card, index) => (
          <div className='h-[435px] bg-[#1B1C1E] rounded-[18px] px-6 py-8 text-left hover:bg-transparent hover:border-2' key={index}>
